<?php namespace Domain\Patterns\Tests\Structural\Flyweight;

use Domain\Patterns\Structural\Flyweight\FlyweightFactory;
use PHPUnit_Framework_TestCase as TestCase;

/**
 * Class FlyweightTest
 * @package Domain\Patterns\Tests\Structural\Flyweight
 */
